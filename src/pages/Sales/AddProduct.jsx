              ...
              <Form>
                <div className="pocketExpense-form">
                  <div className="pef-inner">
                      ...
                      <div className="pefi-area" style={{ marginLeft: "50px" }}>
                        ...
                        <div className="fields">
                          <div className="inner-field">
                            <p className="currency" style={{ boxShadow:"none"  }}>£</p>
                            <Field id="value" name="value" placeholder="0" style={{ width: "100%", boxShadow:"none"  }} />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div role="group" aria-labelledby="my-radio-group" className="radio-rows" style={{margin:"2% auto"}}>
                      {/* <label>
                    ...
                    <div role="group" aria-labelledby="my-radio-group" className="radio-row" style={{margin:"2% auto"}}>
                      ...
                      <div className="radio-row-down" style={{marginTop:"30px"}}>
                        <label>
                          <Field type="radio" name="rate" value={'0'} />
                          Custom Rate
                        </label>
                        <label style={{margin:"0 11.4%"}}>
                          <Field type="radio" name="rate" value={'0'} />
                          Zero Rate
                        </label>
                      </div>
