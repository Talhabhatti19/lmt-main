          ...
          <div className="expenses-section">
            <div className="es-area">
              <div className="es-inner">
                ...
                <Link to="/profitloss" style={{color:"black"}}>
                ...
                <Link to="/balancesheet" style={{color:"black"}}>
                <div className="esi-content">
                ...
                <Link to="/dividend-ab" style={{color:"black"}}>
                <div className="esi-content">
                ...
                <Link to="/money-owed" style={{color:"black"}}>
                <div className="esi-content">
                ...
                <Link to='/money-business-owed' style={{color:"black"}}>
                <div className="esi-content">
                  <img src={MoneyOwed} alt="money-owed" />
                  <div className="esic-inner">
                ...
                <Link to="/personal-tax" style={{color:"black"}}>
                <div className="esi-content">
