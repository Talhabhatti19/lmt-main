...
const ClientLogin = () => {
  ...
  const handleGoogle = async (loginData) => {
    
      try {
        let result = await LAMT_API.endpoints.clientAdmin.withGoogleOpen(loginData);
        console.log(result,"hellooooo");
      ...
      <div className='login-container'>
        <Box className='login-inner'>
          ...
          <Box className='first-login'>
            ...
            <Link to={'/user/signup'} underline="none" className='singup-sign'>
              Sign up
            </Link>
          </Box>
