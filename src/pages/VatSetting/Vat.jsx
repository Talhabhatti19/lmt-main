                  ...
                  <Form>
                    <div className="dsp-radio">
                      ...
                      <div className="dsp-inner-radio">
                        <p style={{ fontSize: "15.5px" }}>VAT Number</p>
                        ...
                        <div className="dsp-label">
                          <p style={{ fontSize: "15.5px" }}>What VAT scheme are you on?</p>
                          <div className='vat-radio'>
                            <label>
                              <Field type="radio" name="picked" value={'1'} />
                              Standard
                            </label>
                            <label style={{ margin: "0 100px" }}>
                              <Field type="radio" name="picked" value={'1'} />
                              Flat Rate
                            </label>
                          </div>

                          <p style={{ fontSize: "15.5px" }}>Registration date for VAT</p>
                      ...
                      <button style={{ fontSize: "16px", padding: "20px", background: "rgb(99, 94, 255)", color: "white", borderRadius: "6px", border: "none", width: "100%", margin: "2% 3% 3% 0%", cursor: "pointer" }}>Save VAT Settings</button>
                    </div>
                  </Form>
                </Formik>
